...
// Type for lesson description
type LessonDescription = { target: string; native: string }

// Type for vocabulary item
type VocabularyItem = {
  word: string
        ...
        {userLessons.length === 0 ? (
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
            {userLessons.map((lesson) => {
              const description = lesson.description as LessonDescription
              const vocabulary = lesson.vocabulary as VocabularyItem[]
